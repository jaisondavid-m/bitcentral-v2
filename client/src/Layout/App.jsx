...
const ProfileV2 = lazyWithRetry(() => import("../Pages/ProfileV2.jsx"));
const Home = lazyWithRetry(() => import("../Pages/Home.jsx"));
const About = lazyWithRetry(() => import("../Pages/About.jsx"));
const Developer = lazyWithRetry(() => import("../Pages/Developer.jsx"));
const Features = lazyWithRetry(() => import("../Pages/Features.jsx"));
...
const Rpsite = lazyWithRetry(() => import("../Pages/Rpsite.jsx"));
const Semester = lazyWithRetry(() => import("../Pages/Semester.jsx"));
const MessMenu = lazyWithRetry(() => import("../Pages/MessMenu.jsx"));
const PCDP = lazyWithRetry(() => import("../Pages/PCDP.jsx"));
const FindMyWay = lazyWithRetry(() => import("../Pages/FindMyWay.jsx"));
const Apsite = lazyWithRetry(() => import("../Pages/Apsite.jsx"));
const NotFound = lazyWithRetry(() => import("../Pages/NotFound.jsx"));
const LeaveDetails = lazyWithRetry(() => import("../Pages/LeaveDetails.jsx"));
const ExamHall = lazyWithRetry(() => import("../Pages/ExamHall.jsx"));
const ExamHallDownload = lazyWithRetry(() => import("../Pages/ExamHallDownload.jsx"));
const UserDirectory = lazyWithRetry(() => import("../Pages/UserDirectory.jsx"));
const StudentReportDetails = lazyWithRetry(() => import("../Pages/StudentReportDetails.jsx"));
const PSAssessmentHistory = lazyWithRetry(() => import("../Pages/PSAssessmentHistory.jsx"));
const PSPointDetails = lazyWithRetry(() => import("../Pages/PSPointDetails.jsx"));
const PSBiometricDetails = lazyWithRetry(() => import("../Pages/PSBiometricDetails.jsx"));
const SupportDev = lazyWithRetry(() => import("../Pages/SupportDev.jsx"));
const PaymentSuccessful = lazyWithRetry(() => import("../Pages/PaymentSuccessful.jsx"));
const WifiDetails = lazyWithRetry(() => import("../Pages/WifiDetails.jsx"));
...
// const DocsPage = lazyWithRetry(() => import("../Pages/AboutDocs.jsx"));
